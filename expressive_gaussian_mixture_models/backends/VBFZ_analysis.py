...
obs_proj_linear_fraction_data_space = {}
obs_proj_linear_fraction_data_space ["Dphi_j_j"] = 0.8
obs_proj_linear_fraction_data_space ["Dy_j_j"  ] = 0.8
obs_proj_linear_fraction_data_space ["m_jj"    ] = 0.2
obs_proj_linear_fraction_data_space ["m_ll"    ] = 0.8
obs_proj_linear_fraction_data_space ["pT_j1"   ] = 0.2
obs_proj_linear_fraction_data_space ["pT_j2"   ] = 0.2
obs_proj_linear_fraction_data_space ["pT_jj"   ] = 0.2
obs_proj_linear_fraction_data_space ["pT_ll"   ] = 0.2
obs_proj_linear_fraction_data_space ["rap_jj"  ] = 0.2
obs_proj_linear_fraction_data_space ["rap_ll"  ] = 0.8
...
def configure (remove_more_observables, reverse=False, order=[]) :
    ...
    remove_observables = remove_observables + remove_more_observables
...
def get_obs_proj_linear_fraction_data_space (obs) :
    if obs in obs_proj_linear_fraction_data_space :
        return obs_proj_linear_fraction_data_space[obs]
    raise RuntimeWarning(f"WARNING - no obs_proj_linear_fraction_data_space found for observable {obs} (returning 0.5 by default)")
    return 0.5

def get_obs_proj_linear_fraction_latent_space (obs) :
    return 0.    # Must be 0, otherwise we get hard boundaries on latent space which our GMM can't capture
