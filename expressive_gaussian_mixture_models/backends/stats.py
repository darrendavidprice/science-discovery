...
#  Brief:  Alias for whiten_axes
#
def project_axes_onto_latent (data, types, axis_configs=None, proj_funcs=None, weights=None, **kwargs) :
    return whiten_axes(data, types, axis_configs=axis_configs, whitening_funcs=proj_funcs, weights=weights, **kwargs)

 
#  Brief:  Alias for unwhiten_axes
#
def project_axes_from_latent (white_data, proj_funcs) :
    return unwhiten_axes(white_data, proj_funcs)
