...
class Distribution :
	## Default constructor
	# 
	def __init__ (self, other=None, length=None, values=None, cov=None, n_toys=1000, name="", includes_SM=True) :
		...
		if other is not None :
			...
			self.cov         = other.cov
			if hasattr(other, "n_toys") : self.n_toys = other.n_toys
			self.includes_SM = other.includes_SM
			return
	...
	# 
	def generate_toys (self, n_toys=None) :
		if n_toys is None : n_toys = self.n_toys
